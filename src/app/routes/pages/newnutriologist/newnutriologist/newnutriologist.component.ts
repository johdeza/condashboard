...
export class NewnutriologistComponent implements OnInit {
  ...
  constructor(private newnutriologistService: NewnutriologistService ) { }
  ...
  savedNutriologist() {
    ...
    this.newnutriologistService.savedNutriologist(this.newNutriologist.value).subscribe(res =>
      console.log(res))
  }
